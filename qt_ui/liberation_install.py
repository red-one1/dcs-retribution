...
def init():
    ...
    if PREFERENCES_PATH.exists():
        try:
            ...
            __save_format = pref_data.get("save_format", "classic")
...
def setup(
    ...
    __server_port = port
    __save_format = save_format
    persistency.setup(saved_game_dir, prefer_liberation_payloads, port, save_format)
