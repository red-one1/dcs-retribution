...
class WeaponsF4EExpanded:
    ...
    _Special_Weapons_Adapter__TGM_65D___Trg_Round_for_Mav_D__IIR___LAU_117__Special_Weapons_Adapter__ = WeaponDef(
    ...
    _Special_Weapons_Adapter__TGM_65H___Trg_Round_for_Mav_H__CCD___LAU_117__Special_Weapons_Adapter__ = WeaponDef(
